...
(function (XMPPEvents) {
    ...
    XMPPEvents["WHITEBOARD"] = "xmpp.whiteboard";
     ...
     */
    XMPPEvents["PARTICIPANT_LOG_RECEIVED"] = "xmpp.participant_log_received";
    /**
    ...
    */
     ...
     */
    XMPPEvents["BREAKOUT_ROOMS_ATTENTION_UPDATED"] = "xmpp.breakout-rooms.attention_updated";
    /**
    ...
    XMPPEvents["TIME_REMAINED"] = "xmpp.time_remained";
    XMPPEvents["NOTICE_MESSAGE"] = "xmpp.notice_message";
    // Designates an event indicating that random-selection has started.
    XMPPEvents["NOTIFY_RANDOM_SELECTION_STARTED"] = "xmpp.notify_random_selection_started";
    // Designates an event indicating that random-selection has finished.
    XMPPEvents["NOTIFY_RANDOM_SELECTION_FINISHED"] = "xmpp.notify_random_selection_finished";
    // Designates an event indicating that timer has started.
    XMPPEvents["NOTIFY_TIMER_STARTED"] = "xmpp.notify_timer_started";
    // Designates an event indicating that birthday hat is to put on.
    XMPPEvents["NOTIFY_BIRTHDAY_HAT_ON"] = "xmpp.birthday_hat_on";
    // Designates an event indicating that timer has finished.
    XMPPEvents["NOTIFY_TIMER_FINISHED"] = "xmpp.notify_timer_finished";
    // Designates an event indicating that random participant has selected.
    XMPPEvents["PIN_RANDOM_PARTICIPANT"] = "xmpp.pin_random_participant";
    // Designates an event indicating that random selection countdown has started.
    XMPPEvents["RANDOM_SELECTION_COUNTDOWN"] = "xmpp.random_selection_countdown";
    // Designates an event indicating that birthday flag has updated.
    XMPPEvents["PARTICIPANT_BIRTHDAY_FLAG_UPDATED"] = "xmpp.birthday_flag_updated";
    // Designates an event indicating that face detect has enabled.
    XMPPEvents["FACE_DETECT_ENABLED"] = "xmpp.face_detect_enabled";
    XMPPEvents["STT_ENABLED"] = "xmpp.stt_enabled";
