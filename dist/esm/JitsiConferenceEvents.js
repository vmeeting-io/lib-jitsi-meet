...
(function (JitsiConferenceEvents) {
    ...
    JitsiConferenceEvents["TIME_REMAINED"] = "conference.time_remained";
    JitsiConferenceEvents["NOTIFY_RANDOM_SELECTION_STARTED"] = "conference.notify_random_selection_started";
    JitsiConferenceEvents["RANDOM_SELECTION_COUNTDOWN"] = "conference.random_selection_countdown";
    JitsiConferenceEvents["PIN_RANDOM_PARTICIPANT"] = "conference.pin_random_participant";
    JitsiConferenceEvents["NOTIFY_RANDOM_SELECTION_FINISHED"] = "conference.notify_random_selection_finished";
    JitsiConferenceEvents["PARTICIPANT_BIRTHDAY_FLAG_UPDATED"] = "conference.birthday_flag_updated";
    // Notifies timer started.
    JitsiConferenceEvents["NOTIFY_TIMER_STARTED"] = "conference.notify_timer_started";
    // Notifies timer finished.
    JitsiConferenceEvents["NOTIFY_TIMER_FINISHED"] = "conference.notify_timer_finished";
    // Notifies birthdayhat on participant.
    JitsiConferenceEvents["NOTIFY_BIRTHDAY_HAT_ON"] = "conference.notify_birthday_hat_on";
    JitsiConferenceEvents["NOTICE_MESSAGE"] = "conference.notice_message";
    /**
     * Event fired when the attention status was updated.
     */
    JitsiConferenceEvents["BREAKOUT_ROOMS_ATTENTION_UPDATED"] = "conference.breakout-rooms.attention-updated";
    /**
     * Event fired when face detect was enabled.
     */
    JitsiConferenceEvents["FACE_DETECT_ENABLED"] = "conference.face_detect.enabled";
    JitsiConferenceEvents["STT_ENABLED"] = "conference.stt.enabled";
