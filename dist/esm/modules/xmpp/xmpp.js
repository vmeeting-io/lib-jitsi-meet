...
export default class XMPP extends Listenable {
    ...
    */
    ...
    createRoom(roomName, options, onCreateResource) {
        ...
        roomjid += mucNickname;
        return this.connection.emuc.createRoom(roomjid, options === null || options === void 0 ? void 0 : options.password, options);
    }
    /**
    ...
    _onPrivateMessage(msg) {
        ...
        if (parsedJson
            ...
            && parsedJson.log) {
            this.eventEmitter.emit(XMPPEvents.PARTICIPANT_LOG_RECEIVED, parsedJson.log);
        }
        return true;
    }
    /**
