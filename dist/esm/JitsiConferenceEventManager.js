...
JitsiConferenceEventManager.prototype.setupChatRoomListeners = function () {
    ...
    chatRoom.addListener(XMPPEvents.AUDIO_MUTED_BY_FOCUS, (actor, mute) => {
    ...
    chatRoom.addListener(XMPPEvents.VIDEO_MUTED_BY_FOCUS, (actor, mute) => {
        // TODO: Add a way to differentiate between commands which caused
        // us to mute and those that did not change our state (i.e. we were
        // already muted).
    ...
    this.chatRoomForwarder.forward(XMPPEvents.TIME_REMAINED, JitsiConferenceEvents.TIME_REMAINED);
    this.chatRoomForwarder.forward(XMPPEvents.FACE_DETECT_ENABLED, JitsiConferenceEvents.FACE_DETECT_ENABLED);
    this.chatRoomForwarder.forward(XMPPEvents.STT_ENABLED, JitsiConferenceEvents.STT_ENABLED);
    this.chatRoomForwarder.forward(XMPPEvents.NOTIFY_RANDOM_SELECTION_STARTED, JitsiConferenceEvents.NOTIFY_RANDOM_SELECTION_STARTED);
    this.chatRoomForwarder.forward(XMPPEvents.RANDOM_SELECTION_COUNTDOWN, JitsiConferenceEvents.RANDOM_SELECTION_COUNTDOWN);
    this.chatRoomForwarder.forward(XMPPEvents.NOTIFY_RANDOM_SELECTION_FINISHED, JitsiConferenceEvents.NOTIFY_RANDOM_SELECTION_FINISHED);
    this.chatRoomForwarder.forward(XMPPEvents.PARTICIPANT_BIRTHDAY_FLAG_UPDATED, JitsiConferenceEvents.PARTICIPANT_BIRTHDAY_FLAG_UPDATED);
    this.chatRoomForwarder.forward(XMPPEvents.NOTIFY_BIRTHDAY_HAT_ON, JitsiConferenceEvents.NOTIFY_BIRTHDAY_HAT_ON);
    this.chatRoomForwarder.forward(XMPPEvents.NOTIFY_TIMER_STARTED, JitsiConferenceEvents.NOTIFY_TIMER_STARTED);
    this.chatRoomForwarder.forward(XMPPEvents.NOTIFY_TIMER_FINISHED, JitsiConferenceEvents.NOTIFY_TIMER_FINISHED);
    this.chatRoomForwarder.forward(XMPPEvents.PIN_RANDOM_PARTICIPANT, JitsiConferenceEvents.PIN_RANDOM_PARTICIPANT);
    this.chatRoomForwarder.forward(XMPPEvents.MUC_JOINED, JitsiConferenceEvents.CONFERENCE_JOINED);
    this.chatRoomForwarder.forward(XMPPEvents.NOTICE_MESSAGE, JitsiConferenceEvents.NOTICE_MESSAGE);
    ...
    this.chatRoomForwarder.forward(XMPPEvents.BREAKOUT_ROOMS_ATTENTION_UPDATED, JitsiConferenceEvents.BREAKOUT_ROOMS_ATTENTION_UPDATED);
    // Room metadata.
...
JitsiConferenceEventManager.prototype.setupXMPPListeners = function () {
    ...
    this._addConferenceXMPPListener(XMPPEvents.AV_MODERATION_CHANGED, (value, kind, actor) => {
    ...
    this._addConferenceXMPPListener(XMPPEvents.AV_MODERATION_PARTICIPANT_APPROVED, (kind, jid) => {
    ...
    this._addConferenceXMPPListener(XMPPEvents.AV_MODERATION_PARTICIPANT_REJECTED, (kind, jid) => {
        const participant = conference.getParticipantById(Strophe.getResourceFromJid(jid));
        if (participant) {
    ...
    this._addConferenceXMPPListener(XMPPEvents.AV_MODERATION_APPROVED, value => conference.eventEmitter.emit(JitsiConferenceEvents.AV_MODERATION_APPROVED, { kind: value }));
